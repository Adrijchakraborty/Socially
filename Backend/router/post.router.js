...
import { createPost, editComments, editLikes, getAllPosts, getFollowingFeedPosts, getPost, getUserPosts } from '../controller/post.controller.js';
...
router.get('/get-all', verifyToken , getAllPosts);
